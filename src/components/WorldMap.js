...
const WorldMap = (props) => {
  ...
  const handleMarkerClick = (countryIndex) => {
    console.log('Marker: ', cities[countryIndex]);
    window.alert(cities[countryIndex].name + ' has ' + cities[countryIndex].population + ' people')
  }

  return (
    <svg width={ 1080 } height={ 600 } viewBox="0 0 800 450" className={props.className}>
